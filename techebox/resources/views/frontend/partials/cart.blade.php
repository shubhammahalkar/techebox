...
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown" data-display="static">
    <img src="{{ static_asset('assets/img/box.png') }}" class="box_img" alt="alt" />
    <span class="flex-grow-1 ml-1">
        @if(isset($cart) && count($cart) > 0)
        <span class="d-flex d-lg-flex left-badge badge badge-primary badge-inline badge-pill cart-count">
                {{ count($cart)}}
            </span>
        @else
        <span class="d-flex d-lg-flex left-badge badge badge-primary badge-inline badge-pill cart-count">0</span>
        @endif
