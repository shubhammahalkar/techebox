                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="text-left">
                        ...
                        <div class="margin-top-bottem-10">
                            <div class="row">
                                <div class="col-3 col-md-2 specification-b-right">
                                    <img class="img-responsive ml-2 specimg" src="{{static_asset('assets/img/ram.png')}}"  >
                                        <div class="text-center">
                                            <span class="text-center fs-14 fw-600">RAM</span>
                                        </div>
                                        <div class="center ">
                                ...
                                <div class="col-3 col-md-2 specification-b-right">
                                    <img class="img-responsive ml-2 specimg" src="{{static_asset('assets/img/ram.png')}}" >
                                        <div class="center">
                                            <span class=" fs-14 fw-600">Processor</span>
                                        </div>
                                        <div class="text-center">
                                ...
                                <div class="col-3 col-md-2 specification-b-right">
                                    <img class="img-responsive ml-2 specimg" src="{{static_asset('assets/img/ram.png')}}" >
                                        <div class="text-center" >
                                            <span class=" fs-14 fw-600">RAM</span>
                                        </div>
                                        <div class="text-center" >
                                            <span class="fs-16 fw-700 text-color-orange">8 GB</span>
                                        </div>
                        ...
                        <div class="row no-gutters my-1 mt-2">
                            ...
                            @if($categoryOffers)
                            @foreach ($categoryOffers as $poffer)
                            <div class="col-sm-12">
                                <div class="fs-14" style="margin-bottom: 3px;">
                                    <span class="text-color-green mr-2"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                    <span class="fw-600">{{$poffer->offer->offer_type->name}}</span>
                                    <span class="strong-700">{{$poffer->offer->title}} </span><span class="tc-div" id="tandc" data-toggle="modal"  data-target="#offer_modal_{{$poffer->id}}"><b>T&C </b></span>
                                </div>
                            </div>
                            @endforeach
                            @endif
                            @foreach ($detailedProduct->productOffers->take(1) as $poffer)
                            ...
                            <div class="col-sm-12 mt-2 ml-4">
                                <div class="fs-14 pl-1" style="margin-bottom: 15px;">
                                    <a href="#"> <span class="text-color-orange marginleftoffer">View 3 More offers</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row no-gutters mt-1">
                        ...
                        <div class="seller mobile-sec product-spec">
                            <div class="row ">

                                <div class="col-2 col-md-2 mt-2" style="margin-left: 60px">
                                    <img src="{{ static_asset('assets/img/cash.png') }}" class="border mt-2 mb-2 text-center " alt="" style="background-color: white; border-radius: 50%;">


                                    <span class="fw-700  text-center ">Installation </span>
                                    <span class="fw-700   text-center"> not required</span>
                                                ...
                                                <div class="p-4">
                                                    <div class="row no-gutters border-gray pb-3">
                                                        <div class="col-12 p-2">
                                                            <div class="product-description-label mt-2 fs-07 fw-600">Q:is pipes are metal or not?  </div>
                                                            <div class="product-description-label mt-1 heading-4">A:yes. all pipes are made of metal. only the joints are plastic.</div>
