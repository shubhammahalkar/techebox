        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" placeholder="{{ translate('Your Email')}}" name="email" value="{{ Auth::user()->email }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">{{ translate('Phone') }}</label>
                    <div class="col-md-10">
                        <input type="text"   pattern="\d[0-9]{10}" maxlength="10" class="form-control" onkeypress="phone()" placeholder="{{ translate('Your Phone')}}" name="phone" value="{{ Auth::user()->phone }}">
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="row gutters-10">
                ...
                <div class="col-lg-6 mx-auto"  >
                    <div id="mod" class="border p-3 rounded mb-3 c-pointer text-center bg-light">
