...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/custome.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/set.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/slider.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/mediya_query.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/changes.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/css/jquery.bxslider.css') }}">
...
<script type="text/javascript">
    ...
    function doOnlineCheck() {
        if (navigator.onLine == true) {
            ...
            // console.log("offline");
            showFrontendAlertNoInternet('error', 'No Internet Connection.');
        }
        checkOnline();
    }

    function showFrontendAlertNoInternet(type, message) {
        if (type == 'danger') {
            type = 'error';
        }
        swal({
...
<body >
    ...
    <!-- SCRIPTS -->
    {{-- <script src="{{ static_asset('assets/js/jquery-2.2.0.min.js') }}"></script>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script> --}}
    ...
    <script src="{{ static_asset('assets/js/circle.js') }}"></script>

    <script src="{{ static_asset('assets/js/jquery.bxslider.min.js') }}"></script>

    <script src="{{ static_asset('assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ static_asset('assets/js/share.js') }}"></script>
    <script src="{{ static_asset('assets/js/scripts.js') }}"></script>
    <script src="{{ static_asset('assets/js/rotator.js') }}"></script>
