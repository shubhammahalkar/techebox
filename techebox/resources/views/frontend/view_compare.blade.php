...
<section class="pt-4 mb-4">
    <div class="container text-center">
        <div class="row bg-white border-radious-3">
            <div class="col-lg-6 text-center mt-3 text-lg-left">
                <h1 class="fw-600 h4">{{ translate('Compare')}}</h1>
            </div>
            <div class="col-lg-6 mt-4">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    <li class="breadcrumb-item opacity-50">
                        <a class="text-color-black" href="{{ route('home') }}">{{ translate('Home')}}</a>
                    </li>
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-color-black" href="{{ route('compare.reset') }}">"{{ translate('Compare')}}"</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class=" mt-4 ">
    <h6 class="p-4 fs-20 fw-700 text-color-orange text-center"> General</h6>
</div>
<section class="mb-4">
    <div class="container text-left">
        <div class="bg-white shadow-sm rounded">
                ...
                @if(count(Session::get('compare')) > 0)
                    <div class="p-3">
                        <table class="table table-responsive table-bordered mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">{{ translate('Storage')}}</th>
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td>
                                            <img loading="lazy" src="{{ uploaded_asset(\App\Models\Product::find($item)->thumbnail_img) }}" alt="{{ translate('Product Image') }}" class="img-fluid py-4">
                                        </td>
                                ...
                                <tr>
                                    <th scope="row">{{ translate('Processor')}}</th>
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td>
                                            @if (\App\Models\Product::find($item)->brand != null)
                                                {{ \App\Models\Product::find($item)->brand->getTranslation('name') }}
                                ...
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td class="text-center py-4">
                                            ...
                                            <button type="button" class="btn btn-primary fw-600" onclick="showAddToWishlistModal({{ $item }})">
...
<div class=" mt-4 ">
    <h6 class="p-4 fs-20 fw-700 text-color-orange text-center"> Display Features</h6>
</div>
<section class="mb-4">
    <div class="container text-left">
        <div class="bg-white shadow-sm rounded">
...
<div class=" mt-4 ">
    <h6 class="p-4 fs-20 fw-700 text-color-orange text-center"> Camera Features</h6>
</div>
<section class="mb-4">
    <div class="container text-left">
        <div class="bg-white shadow-sm rounded">
...
<div class=" mt-4 ">
    <h6 class="p-4 fs-20 fw-700 text-color-orange text-center"> Connectivity Features</h6>
</div>
<section class="mb-4">
    <div class="container text-left">
        <div class="bg-white shadow-sm rounded">
