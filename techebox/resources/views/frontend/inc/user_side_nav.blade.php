                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('digital_purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['digital_purchase_history.index'])}}">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Digital Library') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{route('customer_care.index')}}" class="aiz-side-nav-link">
                            <i class="las la-file-alt aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Customer Care') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{route('products.sugesion_criteria')}}" class="aiz-side-nav-link">
                            <i class="las la-file-alt aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Suggestion Criteria') }}</span>
                        </a>
                    </li>
