...
<div class="card">
	<form action="{{ route('custom-zones.store') }}" method="POST" enctype="multipart/form-data">
		@csrf
		<div class="card-header">
			<h6 class="fw-600 mb-0">{{ translate('Zone Content') }}</h6>
		</div>
		<div class="card-body">
		...
		<div class="card-body">
			...
			<div class="text-right">
				<button type="submit" class="btn btn-primary">{{ translate('Save Zone') }}</button>
			</div>
		</div>
	</form>
</div>
