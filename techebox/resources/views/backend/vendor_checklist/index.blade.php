...
<div class="aiz-titlebar text-left mt-2 mb-3">
    ...
    <div class="form-group mb-3 text-right">
        <a type="submit" href="{{route('vendor_checklist.create')}}" class="btn btn-primary">{{translate('Add New Question')}}</a>
    </div>
</div>
						...
						@foreach($questions as $key => $q)
							<tr>
								...
								<td class="text-right">
									...
									<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('vendor_checklist.edit', $q->id)}}" title="{{ translate('Edit') }}">
										<i class="las la-edit"></i>
									</a>
									<a  class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" href="{{route('vendor_checklist.destroy', $q->id)}}" title="{{ translate('Delete') }}">
