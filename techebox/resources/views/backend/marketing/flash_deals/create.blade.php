            ...
            <div class="card-body">
                <form action="{{ route('flash_deals.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group ml-3 mb-4 p-1">
                            ...
                            <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="banner_1_img" class="selected-files">

                            </div>
                            <input type="text" placeholder="{{translate('URL')}}" name="banner_1_url" class="form-control">
                            <div class="file-preview box sm">
                            </div>
                        </div>
                        <div class="form-group mb-3 p-1">
                            ...
                            <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="banner_2_img" class="selected-files">
                            </div>
                            <input type="text" placeholder="{{translate('URL')}}" name="banner_2_url" class="form-control">
                            <div class="file-preview box sm">
                            </div>
                        </div>
                        <div class="form-group mb-3 p-1">
                            ...
                            <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="banner_3_img" class="selected-files">
                            </div>
                            <input type="text" placeholder="{{translate('URL')}}" name="banner_3_url" class="form-control" >
                            <div class="file-preview box sm">
                            </div>
                        </div>
                        <div class="form-group mb-3 p-1">
                            ...
                            <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="banner_4_img" class="selected-files">
                            </div>
                            <input type="text" placeholder="{{translate('URL')}}" name="banner_4_url" class="form-control" >
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    </div>
