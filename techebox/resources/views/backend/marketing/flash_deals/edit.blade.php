                  ...
                  <input type="hidden" name="lang" value="{{ $lang }}">
                    ...
                    <div class="form-group mb-3 p-1">
                        ...
                        <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" value="{{ $flash_deal->banner_1_img }}" name="banner_1_img" class="selected-files">

                        </div>
                        <input type="text" placeholder="{{translate('URL')}}"  value="{{ $flash_deal->banner_1_url }}" name="banner_1_url" class="form-control">
                        <div class="file-preview box sm">
                        </div>
                    </div>
                    <div class="form-group mb-3 p-1">
                        ...
                        <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" value="{{ $flash_deal->banner_2_img }}" name="banner_2_img" class="selected-files">
                        </div>
                        <input type="text" placeholder="{{translate('URL')}}" value="{{ $flash_deal->banner_2_url }}" name="banner_2_url" class="form-control">
                        <div class="file-preview box sm">
                        </div>
                    </div>
                    <div class="form-group mb-3 p-1">
                        ...
                        <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" value="{{ $flash_deal->banner_3_img }}" name="banner_3_img" class="selected-files">
                        </div>
                        <input type="text" placeholder="{{translate('URL')}}" value="{{ $flash_deal->banner_3_url }}" name="banner_1_url" class="form-control" >
                        <div class="file-preview box sm">
                        </div>
                    </div>
                    <div class="form-group mb-3 p-1">
                        ...
                        <div class="input-group mb-2" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" value="{{ $flash_deal->banner_4_img }}" name="banner_4_img" class="selected-files">
                        </div>
                        <input type="text" placeholder="{{translate('URL')}}" value="{{ $flash_deal->banner_4_url }}" name="banner_4_url" class="form-control" >
                        <div class="file-preview box sm">
                        </div>
                    </div>
