...
<div class="aiz-titlebar text-left mt-2 mb-3">
    ...
    <div class="form-group mb-3 text-right">
        <a type="submit" href="{{route('customer_cancellation.create')}}" class="btn btn-primary">{{translate('Add New Reason')}}</a>
    </div>
</div>
						...
						@foreach($reasons as $key => $reason)
							<tr>
								...
								<td class="text-right">
									...
									<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('customer_cancellation.edit', $reason->id)}}" title="{{ translate('Edit') }}">
										<i class="las la-edit"></i>
									</a>
									<a  class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" href="{{route('customer_cancellation.destroy', $reason->id)}}" title="{{ translate('Delete') }}">
