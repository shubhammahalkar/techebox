...
<div class="row">
	...
	<div class="offset-lg-2 col-md-6">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('customer_replacement_reason.update', $reason->id) }}" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group mb-3">
						...
						<input type="text" placeholder="{{ translate('Name')}}" id="name" name="reason" class="form-control" required>
					</div>
