    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <!-- Product -->
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('user_tags.index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('User Tags')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-tag aiz-side-nav-icon"></i>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('subsubcategories.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Sub Sub Category')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('review_factors.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Review Factors')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('category_attribute_heads.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','attributes.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Category Attribute Heads')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('category_attributes.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['category_attributes.index','category_attributes.create','category_attributes.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Category Attribute')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('23', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('brands.index') }}" class="aiz-side-nav-link">
                            <i class="las la-copyright aiz-side-nav-icon"></i>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-percent  aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Offers Management')}}</span>
                        @if (env("DEMO_MODE") == "On")
                            <span class="badge badge-inline badge-danger">Addon</span>
                        @endif
                        <span class="aiz-side-nav-arrow"></span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('bank_offers.index')}}">
                                <span class="aiz-side-nav-text">{{translate('Bank Offers')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('company_offers.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Company Offers') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('emi_offers.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('EMI Offers') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('CheckList Management')}}</span>
                        @if (env("DEMO_MODE") == "On")
                            <span class="badge badge-inline badge-danger">Addon</span>
                        @endif
                        <span class="aiz-side-nav-arrow"></span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('vendor_cancellation.index')}}">
                                <span class="aiz-side-nav-text">{{translate('Venador Order Cancellation Reasons')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('customer_cancellation.index')}}" class="aiz-side-nav-link " >
                                <span class="aiz-side-nav-text">{{ translate('Customer Order Cancellation Reasons') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('customer_replacement_reason.index')}}" class="aiz-side-nav-link " >
                                <span class="aiz-side-nav-text">{{ translate('Customer Order replacement Reasons') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('customer_return_reason.index')}}" class="aiz-side-nav-link " >
                                <span class="aiz-side-nav-text">{{ translate('Customer Order Return Reasons') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('delivery_boy_checklist.index')}}" class="aiz-side-nav-link"  >
                                <span class="aiz-side-nav-text">{{ translate('Delivery Boy CheckList') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('vendor_checklist.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Vendor CheckList') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-compass aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Gudelines')}}</span>
                        @if (env("DEMO_MODE") == "On")
                            <span class="badge badge-inline badge-danger">Addon</span>
                        @endif
                        <span class="aiz-side-nav-arrow"></span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('buying_guide.index')}}">
                                <span class="aiz-side-nav-text">{{translate('Buying Guides')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('delivery_boy_guide.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Delivery Boy Guides') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('vendor_package_guide.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Vendor Packaging Guides') }}</span>
                            </a>
                        </li>
            ...
            <!-- Reports -->
                ...
                <!--Updates System-->
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Updates System') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('frontend_update.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['frontend_update.create', 'frontend_update.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Posts') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('frontend_update-category.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['frontend_update-category.create', 'frontend_update-category.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Categories') }}</span>
                                </a>
                            </li>
                        </ul>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('23', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('service_centers.index') }}" class="aiz-side-nav-link">
                            <i class="las la-bullhorn aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Service Center') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('23', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('try_guide.index') }}" class="aiz-side-nav-link">
                            <i class="las la-bullhorn aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Try Guide') }}</span>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('website.zones') }}" class="aiz-side-nav-link {{ areActiveRoutes(['website.zones', 'custom-zones.create' ,'custom-zones.edit'])}}">
