...
<div class="row">
        ...
        <div class="card col-md-11 m-4">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Brand Slider') }}</h6>
			</div>
			<div class="card-body">
        ...
        <div class="card col-md-11 m-4">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Sub Category Carousel') }}</h6>
			</div>
			<div class="card-body ">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="subcategories[]" id="product_addon" class="form-control aiz-selectpicker" multiple data-placeholder="{{ translate('Choose Sub Category') }}" data-live-search="true" data-selected-text-format="count">
