                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="unit_price" placeholder="{{ translate('Unit Price') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_model_name_number" placeholder="{{ translate('Model Number/Name') }}" >
                        ...
                        <div class="form-group row"  >
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control " name="ean_upc_code" placeholder="{{ translate('EAN/UPC Code') }}">
                        ...
                        <div class="form-group row"  >
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control " name="hsn_code" placeholder="{{ translate('HSN Code') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control aiz-tag-input" name="search_tags[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
                        ...
                        <div class="form-group row"  >
                            ...
                            <div class="col-md-8">
                                <div class="col-md-8">
                                    <select   id="user_tags" name="user_tags[]" class="form-control demo-select2-placeholder" multiple>
                    ...
                    <div class="card-body">
                        ...
                        <div class="collapse p-4" id="key_feature_div_1">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control  " name="key_feature_labels[]" placeholder="{{ translate('Label') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control  " name="key_feature_values[]" placeholder="{{ translate('Value') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="key_feature_img[]" class="selected-files">
                                    </div>
                            ...
                            <div class="form-group row" id="brand">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control aiz-tag-input" name="key_feature_fa_fa_icons[]" placeholder="{{ translate('Fa Fa Icon') }}">
                                </div>
                        ...
                        <div class="collapse p-4" id="key_feature_div_2">
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Label')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control aiz-tag-input" name="key_feature_labels[]" placeholder="{{ translate('Label') }}">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Value')}} <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control aiz-tag-input" name="key_feature_values[]" placeholder="{{ translate('Value') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="additional_features"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="company_features"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="product_support"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="warranty_type" value="" class="form-control">
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Warranty Detail,Covered in warranty,Not Covered in warranty')}}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="warranty_details"></textarea>
                            </div>
                        </div>
