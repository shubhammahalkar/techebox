...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('Search Products')}}</h1>
        </div>
        @if($type != 'Seller')
...
<div class="card">
    ...
    <!--Horizontal Form-->
    <!--===================================================-->
    {{-- <!-- {{ route('products.admin_search_products') }} --> --}}
    <!--  <form class="form-horizontal" action="" method="GET" enctype="multipart/form-data"> -->
    @csrf
    <div class="card-body row">
        <div class="form-group col-md-6">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Category')}}</label>
                <div class="col-md-8">
        ...
        <div class="form-group col-md-6" id="subcategory">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Subcategory')}}</label>
                <div class="col-md-8">
                    <select name="subcategory_id" id="sub_category_id" class="form-control demo-select2-placeholder"> </select>
                </div>
            </div>
        </div>
        <div class="form-group col-md-6" id="subsubcategory">
            <div class="row">
                <label class="col-md-4 control-label">{{__('Sub Subcategory')}}</label>
                <div class="col-md-8">
                    <select class="form-control demo-select2-placeholder" name="subsubcategory_id" id="sub_sub_category_id"> </select>
                </div>
            </div>
        </div>
        <div class="form-group col-md-6" id="brand">
            <div class="row">
                <label class="col-md-4 control-label">{{__('Brand')}}</label>
                <div class="col-md-8">
        ...
        <div class="form-group col-md-6">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Show Todays Deal Product')}}</label>
                <div class="col-md-8">
                    <select name="todays_deal_list" id="todays_deal_list" class="form-control demo-select2-placeholder">
        ...
        <div class="form-group col-md-6">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Show Published Product')}}</label>
                <div class="col-md-8">
                    <select name="published" id="published" class="form-control demo-select2-placeholder">
                        <option value="NO">{{__('NO')}}</option>
                        <option value="YES">{{__('YES')}}</option>
                    </select>
                </div>
        ...
        <div class="form-group col-md-6">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Show Featured Product')}}</label>
                <div class="col-md-8">
                    <select name="featured" id="featured" class="form-control demo-select2-placeholder">
                        <option value="NO">{{__('NO')}}</option>
                        <option value="YES">{{__('YES')}}</option>
                    </select>
                </div>
        ...
        <div class="form-group col-md-6">
            <div class="row">
                <label class="col-md-4 control-label" for="name">{{__('Show On Day Delivery Product')}}</label>
                <div class="col-md-8">
                    <select name="on_day_delivery" id="on_day_delivery" class="form-control demo-select2-placeholder">
                        <option value="No">{{__('NO')}}</option>
                        <option value="Yes">{{__('YES')}}</option>
                    </select>
                </div>
    ...
    <div class="panel-footer text-right">
        <button class="btn btn-primary" type="submit" id="search_record">{{__('Search')}}</button>
    </div>
    <!--  </form> -->
    <!--===================================================-->
    <!--End Horizontal Form-->
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{translate('Search Priority')}}</th>
                        @if(get_setting('product_approve_by_admin') == 1 && $type == 'Seller')
                            <th data-breakpoints="lg">{{translate('Approved')}}</th>
                        @endif
                        <th data-breakpoints="lg">{{translate('Featured')}}</th>
                        <th data-breakpoints="lg">{{translate('Assured')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="  mb-0">
                                <input onchange="update_priority( {{$product->id}})" value="{{ $product->search_priority }}" id="search_priority" type="text"  >
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('products.config', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Config') }}">
...
@section('script')
    <script type="text/javascript">
        ...
        function update_priority(id){
            ...
            $.post('{{ route('products.priority') }}', {_token:'{{ csrf_token() }}', id:id, value:$('#search_priority').val()}, function(data){
                if(data == 1){
