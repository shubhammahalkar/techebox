...
<div class="row">
	...
	<div class="offset-lg-2 col-md-6">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('category_attributes.store') }}" method="POST">
					@csrf
                    ...
                    <div class="form-group row" id="category">
                        <label class="col-md-3 col-from-label">{{translate('Head')}} <span class="text-danger">*</span></label>
                        <div class="col-md-8">
                            <select class="form-control aiz-selectpicker" name="head_id" id="head_id" data-live-search="true" required>
                                <option value="0">---Select Head ---</option>
                                @foreach ($heads as $category)
