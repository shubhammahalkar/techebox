        ...
        slickCarousel: function () {
            $(".aiz-carousel").not(".slick-initialized").each(function () {
                ...
                $this.slick({
                    ...
                    slidesToScroll: 1,
                    prevArrow:
                        '<button type="button" class="slick-prev"><i class="fas fa-angle-left" style="font-size:32px;padding: 11px 1px 0;"></i></button>',
                    nextArrow:
                        '<button type="button" class="slick-next"><i class="fas fa-angle-right" style="font-size:32px;padding: 11px 4px 0;"></i></button>',
                    responsive: [
                        {
                            breakpoint: 1500,
                            settings: {
