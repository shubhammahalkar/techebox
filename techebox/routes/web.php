...
use App\Http\Controllers\TryGuideController;
...
Route::get('/frontend/zones/{slug}', 'ZoneController@index')->name('zone');
Route::get('/frontend/try_guide','TryGuideController@index')->name('frontend.try_guide');
Route::get('/frontend/try_guidecategory','TryGuideController@show')->name('frontend.try_guidecategory');
...
Route::get('/subcategory/{category_slug}', 'SearchController@listingBySubCategory')->name('products.subcategory');
Route::get('/subsubcategory/{category_slug}', 'SearchController@listingBySubSubCategory')->name('products.subsubcategory');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::post('/customer/update-tag/{id}', 'HomeController@update_usertag')->name('customer.tag.update');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    Route::get('/products/sugesion_criteria', 'HomeController@sugesion')->name('products.sugesion_criteria');
...
Route::get('/frontend_update', 'FrontendUpdateController@all_blog')->name('frontend_update');
Route::get('/frontend_update/{slug}', 'FrontendUpdateController@blog_details')->name('frontend_update.details');
...
Route::get('/customer_care','CustomerCareController@index')->name('customer_care.index');
// Service center
Route::get('/search_service_center', 'ServiceCenterController@search')->name('search_service_center');
Route::post('/search_service_center_ajax', 'ServiceCenterController@ajax_search')->name('search_service_center_ajax');
