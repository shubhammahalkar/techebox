...
class CompanyOfferController extends Controller
{
    ...
    public function index()
    {
        ...
        $company_offers =  $offers->company_offers();
        return view('backend.company_offer.index', compact('company_offers'));
    }
    ...
    public function create()
    {
        ...
        $company_offers =  $offers->company_offers();
        return view('backend.company_offer.create',compact('categories','company_offers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('company_offers.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::where('published', 1)->get();
        return view('backend.company_offer.edit', compact('offer','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(translate('company offers has been updated successfully'))->success();
        return back();
    }
