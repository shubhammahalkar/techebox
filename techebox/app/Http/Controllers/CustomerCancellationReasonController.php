...
class CustomerCancellationReasonController extends Controller
{
    ...
    public function index()
    {
        ...
        $reasons = CustomerCancellationReason::orderBy('created_at', 'desc')->get();
        return view('backend.customer_cancellation_checklist.index', compact('reasons'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.customer_cancellation_checklist.create',compact('categories'));
    }
    ...
    {
        $reasons = new CustomerCancellationReason();
        $reasons->reason = $request->reason;
        $reasons->category_id = $request->category_id;
        $reasons->subcategory_id = $request->subcategory_id;
        $reasons->subsubcategory_id = $request->subsubcategory_id;
        ...
        flash(translate('Reasons has been inserted successfully'))->success();
    ...
    public function edit(Request $request, $id)
    {
        ...
        $reason = CustomerCancellationReason::findOrFail($id);
        $categories = Category::where('published', 1)->get();
        return view('backend.customer_cancellation_checklist.edit', compact('reason','categories'));
    }
    ...
    {
        $reasons = CustomerCancellationReason:: findorfail($id);
        $reasons->reason = $request->reason;
        $reasons->category_id = $request->category_id;
        $reasons->subcategory_id = $request->subcategory_id;
        $reasons->subsubcategory_id = $request->subsubcategory_id;
    ...
    public function destroy($id)
    {
        ...
        CustomerCancellationReason::destroy($id);
