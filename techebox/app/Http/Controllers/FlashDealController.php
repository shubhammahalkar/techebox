...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $flash_deal->banner_1_img = $request->banner_1_img;
        $flash_deal->banner_1_url = $request->banner_1_url;
        $flash_deal->banner_2_img = $request->banner_2_img;
        $flash_deal->banner_2_url = $request->banner_2_url;
        $flash_deal->banner_3_img = $request->banner_3_img;
        $flash_deal->banner_3_url = $request->banner_3_url;
        $flash_deal->banner_4_img = $request->banner_4_img;
        $flash_deal->banner_4_url = $request->banner_4_url;
        if($flash_deal->save()){
