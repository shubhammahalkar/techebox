...
class DeliveryBoyChecklistController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $questions = DeliveryBoyChecklist::orderBy('created_at', 'desc')->get();
        return view('backend.delivery_boy_checklist.index', compact('questions'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.delivery_boy_checklist.create',compact('categories'));
    }
    ...
    {
        $questions = new DeliveryBoyChecklist();
        ...
        return redirect()->route('delivery_boy_checklist.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $questions = DeliveryBoyChecklist::findOrFail($id);
        $categories = Category::where('published', 1)->get();
        return view('backend.delivery_boy_checklist.edit', compact('questions','categories'));
    }
