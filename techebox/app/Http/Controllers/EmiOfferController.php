...
class EmiOfferController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $emi_offers =  $offers->emi_offers();
        return view('backend.emi_offer.index', compact('emi_offers'));
    }
    ...
    public function create()
    {
        ...
        $bank_offers =  $offers->company_offers();
        return view('backend.emi_offer.create',compact('categories','bank_offers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('emi_offers.index');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::where('published', 1)->get();
        return view('backend.emi_offer.edit', compact('offer','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $offer->t_and_c = $request->t_and_c;
        $offer->save();
        flash(translate('emi offers has been updated successfully'))->success();
        return back();
    }
