...
use App\Models\CustomerReplacementReason;
use App\Models\VendorCancellationReason;
use CoreComponentRepository;
use Str;

class CustomerReplacementReasonController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $reasons = CustomerReplacementReason::orderBy('created_at', 'desc')->get();
        return view('backend.customer_replacement_checklist.index', compact('reasons'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.customer_replacement_checklist.create',compact('categories'));
    }
    ...
    {
        $attribute = new CustomerReplacementReason();
        ...
        return redirect()->route('customer_replacement_reason.index');
    }
    ...
    public function show($id)
    {
        ...
        return view("backend.customer_replacement_checklist.index", $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $reason = CustomerReplacementReason::findOrFail($id);
        $categories = Category::where('published', 1)->get();
        return view('backend.customer_replacement_checklist.edit', compact('reason','categories'));
    }
    ...
    {
        $attribute =  CustomerReplacementReason::findorfail($id);
        $attribute->reason = $request->reason;
        $attribute->category_id = $request->category_id;
        $attribute->subcategory_id = $request->subcategory_id;
        $attribute->subsubcategory_id = $request->subsubcategory_id;
    ...
    public function destroy($id)
    {
        ...
        CustomerReplacementReason::destroy($id);
