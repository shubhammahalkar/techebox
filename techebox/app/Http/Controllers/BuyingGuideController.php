...
class BuyingGuideController extends Controller
{
    ...
    public function index()
    {
        ...
        $buying_guide = BuyingGuide::orderBy('created_at', 'desc')->get();
        return view('backend.buying_guide.index', compact('buying_guide'));
    }
    ...
    {
       return view('backend.buying_guide.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('buying_guide.index');
    }
    ...
    {
        $lang      = $request->lang;
        $guide = BuyingGuide::findOrFail($id);
        return view('backend.buying_guide.edit', compact('guide','lang'));
    }
